...
public class _02_FindTheHiddenButton implements ActionListener {
	...
	public void start() {
		...
		String arraySize = JOptionPane.showInputDialog("Enter a positive number. It must be more than five.");
		int size = Integer.parseInt(arraySize);
		
		if(size < 6) {
			JOptionPane.showMessageDialog(null, "The rules said more than five. Nice Try");
			System.exit(0);
		}
		...
		JOptionPane.showMessageDialog(null, "Find the hidden button. It must be the correct one");
